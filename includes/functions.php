	...
	if (!empty($dir) && is_dir($dir)) {
		...
		while(($file = readdir($dh)) !== false) {
			...
			elseif (is_dir($dir.$file)) {
				...
				$links = '<a href="edit.php?dir='.urlencode($dir.$file).'" title="&nbspويـرايــش مـسـيــر&nbsp"><img src="includes/images/directory-edit.png" alt="&nbspويـرايــش&nbsp" /></a>&nbsp;&nbsp;<a href="delete.php?dir='.urlencode($dir.$file).'&amp;token='.substr(md5($_SESSION['token'].$dir.$file), 0, 7).'" title="&nbspحـذف مـسـيــر&nbsp" class="delete"><img src="includes/images/directory-delete.png" alt="&nbspحــذف&nbsp" /></a>';
				...
				$links = '<a href="edit.php?dir='.urlencode($dir).'&amp;file='.urlencode($file).'" title="&nbspويـرايــش فـايــل&nbsp"><img src="includes/images/edit.png" alt="&nbspويـرايــش&nbsp" /></a>&nbsp;&nbsp;<a href="delete.php?dir='.urlencode($dir).'&amp;file='.urlencode($file).'&amp;token='.substr(md5($_SESSION['token'].$dir.$file), 0, 7).'" title="&nbspحـذف فـايــل&nbsp" class="delete"><img src="includes/images/delete.png" alt="&nbspحــذف&nbsp" /></a>';
				
				$list[] = $tabs.'<li id="'.$dir.$file.'"'.$class.'><a href="'.$dir.$file.'" title="&nbspنـمـايــش فـايــل&nbsp">'.$file.'</a><span>'.$links.'</span>'.'</li>';
			}
		}
	}
