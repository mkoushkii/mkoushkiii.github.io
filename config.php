...
// Login information.
$username = 'sourcecodes.ir';
$password = 'sourcecodes.ir';
...
?>
	...
	<h2>&nbsp;« لـطـفـا وارد شـويـد
	<img src="includes/images/logout.png"></h2>

	<form action="index.php" method="post" id="login">
<?php if ($error === true) { ?>
	<p class="error" align="center">&nbsp;لـطـفـاً نـام کـاربـری و کـلـمـه عـبــورِ ِ صـحـیـح را وارد نـمـائـیــد&nbsp;
	<img src="includes/images/error.gif" style=""></p>
<?php } ?>
		<p><label for="username">&nbsp;: نـام کـاربـری&nbsp;</label><input type="text" name="username" id="username" value="sourcecodes.ir"/><br class="clear" /></p>
		<p><label for="password">&nbsp;: کـلـمـه عـبـور&nbsp;</label><input type="password" name="password" id="password" value="sourcecodes.ir"/><br class="clear" /></p>
		<p><input type="submit" name="submit" class="logbutton" value=" ورود " /><br class="clear" /></p>
	</form>
<?php
	get_footer();
}
