...
?>
	<h2>&nbsp;مـديـريـت فـايـل هــا&nbsp;<?php if ($current_dir != $start_dir) { ?><span><a href="index.php?dir=<?php echo dirname($current_dir); ?>"><img src="includes/images/previous.png" alt="Go up one directory" /></a></span><?php } ?></h2>

	<form action="index.php" method="get" id="change">
		<p>
			<select name="dir" id="dir">
				<option value="<?php echo $start_dir ?>">&nbsp;انـتـخـاب مـسـيـر&nbsp;</option>
<?php foreach($dirs as $dir) { ?>
				<option value="<?php echo urlencode($dir); ?>"<?php if ($dir == $current_dir) echo ' selected="selected"'; ?>><?php echo $dir; ?></option>
<?php } ?>
			</select>
			<input type="submit" class="button" value=" ! بــرو " />
		</p>
	</form>
<?php
...
?>
	<p>&nbsp;يـافـت نـشــد&nbsp;<em><?php echo $current_dir; ?></em>&nbsp;فـايـلـي در مـسـيـر&nbsp;</p>
<?php
}
